...
public class MascotaDetallesView extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        background.setMaximumSize(new java.awt.Dimension(300, 200));
        background.setMinimumSize(new java.awt.Dimension(300, 200));
        background.setPreferredSize(new java.awt.Dimension(300, 200));
        background.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        btnCerrarDetalles.setFont(new java.awt.Font("Roboto", 1, 18)); // NOI18N
        btnCerrarDetalles.setForeground(new java.awt.Color(255, 255, 255));
        ...
        background.add(btnCerrarDetalles, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 0, 10, -1));

        lblEspecie.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblEspecie.setForeground(new java.awt.Color(255, 255, 255));
        lblEspecie.setText("Perro");
        background.add(lblEspecie, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 40, -1, -1));

        jLabel3.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        jLabel3.setForeground(new java.awt.Color(255, 255, 255));
        jLabel3.setText("Especie:");
        background.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 40, -1, -1));

        lblPesoPromedio.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblPesoPromedio.setForeground(new java.awt.Color(255, 255, 255));
        lblPesoPromedio.setText("25kg");
        background.add(lblPesoPromedio, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 160, -1, -1));

        lblNacimiento.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblNacimiento.setForeground(new java.awt.Color(255, 255, 255));
        lblNacimiento.setText("14/06/2019");
        background.add(lblNacimiento, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 120, 130, -1));

        jLabel6.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        jLabel6.setForeground(new java.awt.Color(255, 255, 255));
        jLabel6.setText("Sexo:");
        background.add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 60, -1, -1));
        ...
        background.add(lblSexo, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 60, -1, -1));

        jLabel8.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        jLabel8.setForeground(new java.awt.Color(255, 255, 255));
        jLabel8.setText("Raza:");
        background.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, -1, -1));

        lblRaza.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        lblRaza.setForeground(new java.awt.Color(255, 255, 255));
        lblRaza.setText("Beagle");
        background.add(lblRaza, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 80, -1, -1));

        jLabel10.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        jLabel10.setForeground(new java.awt.Color(255, 255, 255));
        jLabel10.setText("Color:");
        background.add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 100, -1, -1));
        ...
        background.add(lblColor, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 100, -1, -1));

        jLabel12.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        jLabel12.setForeground(new java.awt.Color(255, 255, 255));
        jLabel12.setText("Nacimiento:");
        background.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 120, -1, -1));

        jLabel13.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        jLabel13.setForeground(new java.awt.Color(255, 255, 255));
        jLabel13.setText("Peso Promedio:");
        background.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 160, -1, -1));

        jLabel14.setFont(new java.awt.Font("Roboto", 0, 14)); // NOI18N
        jLabel14.setForeground(new java.awt.Color(255, 255, 255));
        jLabel14.setText("Peso:");
        background.add(jLabel14, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 140, -1, -1));
        ...
        background.add(lblPeso, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 140, -1, -1));

        lblAlias.setFont(new java.awt.Font("Roboto", 1, 24)); // NOI18N
        lblAlias.setForeground(new java.awt.Color(255, 255, 255));
        lblAlias.setText("Roque");
        background.add(lblAlias, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 10, -1, -1));

        add(background, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 300, 220));
